...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cycleDom = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"@cycle/cycle-dom\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function main() {
	    return {
	        DOM: Rx.Observable.of((0, _cycleDom.div)([(0, _cycleDom.button)('.refresh', 'Refresh'), (0, _cycleDom.div)('.results', [(0, _cycleDom.h1)('.user-name', '(name)'), (0, _cycleDom.h4)('.user-url', '(url)'), (0, _cycleDom.button)('.follow-btn', 'Follow')])]))
	    };
	}
